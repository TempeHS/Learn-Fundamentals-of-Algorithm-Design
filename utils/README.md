...
- Export notebooks from `lessons/` to `other_formats/markdown_lessons/`
...
```bash
python3 utils/ipynb_to_md.py --input-dir "lessons" --output-dir "other_formats/markdown_lessons"
```

3. Convert markdown lessons to PDF:
